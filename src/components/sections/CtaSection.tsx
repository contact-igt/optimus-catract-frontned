            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-white/70 text-lg font-light leading-relaxed">
                  Book your  cataract screening today. No commitment, no pressure — just answers and a clear path forward to restoring your vision.
                </p>
              </div>

              <div className="space-y-4">
                {[
                  { icon: <CheckCircle2 size={18} />, text: 'Completely  screening — no hidden costs' },
                  { icon: <Clock size={18} />, text: 'Results & consultation in under 30 minutes' },
                  { icon: <Shield size={18} />, text: '98% success rate · 20,000+ eyes restored' },
                  { icon: <Star size={18} />, text: 'Premium IOL technology available' },
                ].map((item, i) => (
