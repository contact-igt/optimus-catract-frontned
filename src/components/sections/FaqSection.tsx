...
const faqs = [
  {
    q: 'Do you provide painless cataract surgery?',
    a: 'Yes. Optimus states that it specializes in painless, micro-incision and laser-assisted cataract surgeries with premium IOLs.'
  },
  {
    q: 'How can I book an appointment?',
    a: 'You can call the helpline, visit the hospital in Arjunganj, or use the appointment and WhatsApp options.'
  },
  {
    q: 'Where is the hospital located?',
    a: 'Optimus Eye Hospital is located at Nihal Tower, Near SAS Hyundai Showroom, Arjunganj, Lucknow, Uttar Pradesh 226002.'
  },
];
      ...
      <div className="container mx-auto px-6 md:px-16 grid lg:grid-cols-[1fr_1.3fr] gap-16 items-start w-full">
        ...
        <FadeIn>
          <div className="flex items-center gap-3 text-[11px] font-semibold tracking-[0.15em] text-[#0c5d69] uppercase mb-6">
            <span className="w-8 h-0.5 bg-[#0c5d69]" /> Cataract Surgery FAQs
          </div>
          ...
          <div className="mt-8 p-5 bg-[#f0f8ff] rounded-2xl border border-[#cae2f2]">
            <p className="text-[#0c5d69] text-sm font-medium mb-1">Pre-Surgery Consultation</p>
