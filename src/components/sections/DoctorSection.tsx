...
const doctors = [
  ...
  },
  {
    ...
    degrees: "MBBS, MS Ophthamology – Gold Medalist",
    role: "Glaucoma & Cataract Surgeon",
    badge: "Glaucoma & Cataract Surgeon",
    summary:
      "Dr. Amit Ghanshyam Gupta strengthens the cataract care team at Optimus with specialist expertise in glaucoma and cataract treatment, helping patients receive well-rounded eye care under experienced supervision.",
    highlights: ["Glaucoma Treatment", "Cataract Treatment", "Well-rounded Care", "Experienced Supervision"],
      ...
      <div className="container mx-auto px-6 md:px-16 max-w-6xl relative z-10 w-full">
        ...
        <FadeIn className="text-center mb-16">
          ...
          <h2 className="font-['Cormorant_Garamond',serif] text-4xl md:text-5xl font-bold text-[#0c5d69] mb-4">
            Meet Our{' '}
            <span className="italic text-[#13a2b7]">Cataract Specialists</span>
          </h2>
        ...
        <FadeIn delay={250}>
          <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-[#0c5d69] border border-[#cae2f2] rounded-2xl px-6 py-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              At Optimus Eye Hospital, patients are treated by experienced eye specialists using a personalized treatment approach based on condition, lifestyle, and medical history.
            </p>
          </div>
        </FadeIn>
